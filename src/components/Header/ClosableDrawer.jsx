...
const ClosableDrawer = (props) => {
    ...
    const menus = [
        {func: selectMenu, label: "Register Product", icon: <AddCircleIcon />, id: "register", value: "/product/edit"},
        {func: selectMenu, label: "Order History", icon: <HistoryIcon />, id: "history", value: "/order/history"},
